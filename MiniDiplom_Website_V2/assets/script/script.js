...
navigation.addEventListener("change", () => {
  const selectedOption = navigation.options[navigation.selectedIndex];

  if (selectedOption.id === "intro") {
    // Apply styles for the "Text" option
  ...
  } else if (selectedOption.id === "schema") {
    // Apply styles for the "Schematic" option
